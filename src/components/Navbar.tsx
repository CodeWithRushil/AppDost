          ...
          >
            <a href="#home" className="flex items-center space-x-4">
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-3xl font-bold bg-gradient-to-r from-blue-700 to-purple-500 bg-clip-text text-transparent">
                  AppDost
                </span>
                <span className="text-lg font-medium bg-gradient-to-r from-blue-700 to-purple-500 bg-clip-text text-transparent">
