      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex rounded-xl items-center space-x-2 px-8 py-4 bg-white text-blue-700 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
          >
